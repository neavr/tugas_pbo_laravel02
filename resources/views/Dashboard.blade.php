            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-1 collapse-inner rounded">
                        <a class="collapse-item active" href="buku">Buku</a>
                    </div>
                    <div class="bg-white py-1 collapse-inner rounded">
                        <a class="collapse-item active" href="anggota">Anggota</a>
                    </div>
                    <div class="bg-white py-1 collapse-inner rounded">
                        <a class="collapse-item active" href="petugas">Petugas</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Anggra</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; #WGAMING_2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
